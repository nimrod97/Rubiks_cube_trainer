                            ...
                            for (int i = 0; i < ordered.length; i++) {
                                if (i == 0) {
                                    if (ordered[i].contains("scanned cube colors")) {
                                        ...
                                        colorsFirst = ordered[i].split("scanned cube colors")[1].split(",");
                                    }
                                    ...
                                    if (ordered[i].contains("scanned cube colors")) {
                                        ...
                                        colorsSecond = ordered[i].split("scanned cube colors")[1].split(",");
                                    }
                                    ordered[i] = ordered[i].replace("'", "");
                                    ordered[i] = ordered[i].replace("{", "");
                                    ordered[i] = ordered[i].replace("}", "");
                                    ...
                                    if (ordered[i].contains("scanned cube colors")) {
                                        ...
                                        colorsThird = ordered[i].split("scanned cube colors")[1].split(",");
                                    }
                                    ordered[i] = ordered[i].replace("'", "");
                                    ordered[i] = ordered[i].replace("{", "");
                                    ordered[i] = ordered[i].replace("}", "");
                                    ...
                                    if (ordered[i].contains("scanned cube colors")) {
                                        ...
                                        colorsFourth = ordered[i].split("scanned cube colors")[1].split(",");
                                    }
                                    ordered[i] = ordered[i].replace("'", "");
                                    ordered[i] = ordered[i].replace("{", "");
                                    ordered[i] = ordered[i].replace("}", "");
